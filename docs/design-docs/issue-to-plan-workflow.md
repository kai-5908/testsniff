...
### Rule 6: issue の受け入れ条件を plan に写像する
...
1. 対象 issue を取得する
2. issue の目的、スコープ、制約、依存関係を整理する
3. `docs/exec-plans/active/` に日本語 plan を作成する
4. 要点をユーザーへ共有し、質問・修正・承認を受ける
5. 承認後に実装する
6. 完了時に plan を `completed/` へ移動する
